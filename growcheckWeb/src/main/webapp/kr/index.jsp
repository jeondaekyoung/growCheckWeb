        ...
        <div class="c-home_calltoaction js-scroll js-anim is-show">
            <section class="c-card-calltoaction js-scroll is-show">
                <div class="c-card-calltoaction_overflow">
                    <div class="c-card-calltoaction_background o-background js-scroll is-show" data-speed="0.5" style="background-image: url(<%=app_path%>/resources/img/startNow.jpg); "></div>
